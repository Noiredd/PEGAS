...
PEGAS is capable of executing the entire launch sequence, bringing your vehicle from launchpad to target orbit.
Short list of included features:
* estimation of the launch window,
* calculation of the launch azimuth,
* atmospheric ascent (two guidance methods),
...
* ...and nearly anything else you want - via [delegates](docs/reference.md#sequence) and [addons](docs/addons.md)!
...
## **[Version 1.3.1 "Olympus" (bugfix) is here!](https://github.com/Noiredd/PEGAS/releases/tag/v1.3.1)**
...
It has been extensively tested with numerous launch vehicles,
from real-world launchers like Atlas V or Saturn V, through user-made vehicles, both in RO and vanilla settings.
