...
GLOBAL upfgConvergenceDelay IS 10.		//	UPFG will start attempting to converge that many seconds before its scheduled activation.
...
GLOBAL upfgConvergenceCriterion IS 0.5.	//	Maximum difference between consecutive UPFG T-go predictions that allow accepting the solution.
