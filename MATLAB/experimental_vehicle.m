...
stage_m0 = 1464000+1094000+141300+100000;   %launch mass [kg]   SLS: boosters, core, EUS, 100t payload
stage_thrust = 32300000+4*1860000;          %thrust ASL [N]     SLS: boosters+core
stage_isp0 = 258.4;                         %ISP ASL [s]        SLS: combined boosters+core
stage_isp1 = 289.9;                         %ISP VAC [s]        SLS: combined boosters+core assuming 2330kN core
...
stage_dm = stage_thrust/(stage_isp0*g0);    %mass flow rate [kg/s]
stage = struct('m0', stage_m0,...
               ...
               'dc', stage_drag);
vehicle(1) = stage;
%second stage: core alone (with some fuel burnt away)
stage_m0 = 841000+141300+100000;          %not-full core, EUS, payload
...
stage_dm = stage_thrust/(stage_isp0*g0);
stage = struct('m0', stage_m0,...
               'dm', stage_dm,...
               'i0', stage_isp0,...
               'i1', stage_isp1,...
