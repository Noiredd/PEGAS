...
subplot(2,3,4); plot(s1_results.Plots.t, s1_results.Plots.angle_srf); title('Flight angle');
subplot(2,3,[2;5]); plot(s1_results.Plots.t, s1_results.Plots.alt); title('Altitude');
